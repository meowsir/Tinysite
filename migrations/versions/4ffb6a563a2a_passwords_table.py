...
Revision ID: 4ffb6a563a2a
Revises: cdd98858e0ec
Create Date: 2020-01-20 23:57:10.896515
...
revision = '4ffb6a563a2a'
down_revision = 'cdd98858e0ec'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('password_name', sa.String(length=120), nullable=True),
    sa.Column('password_body', sa.String(length=120), nullable=True),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_password_password_body'), 'password', ['password_body'], unique=False)
    op.create_index(op.f('ix_password_password_name'), 'password', ['password_name'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_password_password_name'), table_name='password')
    op.drop_index(op.f('ix_password_password_body'), table_name='password')
